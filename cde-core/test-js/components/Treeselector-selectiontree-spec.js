    ...
    describe('TreeSelector.Models.SelectionTree', function() {
        ...
        describe('accepts object literals nested around the "node" property', function() {
          ...
          it('has the correct parent id', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > accepts object literals nested around the "node" property > has the correct parent id');
            expect(model.get('id')).toBe('#parent');
          });
          it('has a single child', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > accepts object literals nested around the "node" property > has a single child');
        ...
        describe('propagates the selection state correctly at a depth of 1 level', function() {
          ...
          it('marks all children as selected upon selecting the root', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > at a depth of 1 level > marks all children as selected upon selecting the root');
          ...
          it('marks all children as unselected upon unselecting the root', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > at a depth of 1 level > marks all children as unselected upon unselecting the root');
          ...
          it('is partially selected if only some of its children are selected', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > at a depth of 1 level > is partially selected if only some of its children are selected');
            model.setSelection(false);
        ...
        describe('propagates the selection state correctly at a depth of 2 levels', function() {
          ...
          it('marks all children as selected upon selecting the root', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > at a depth of 2 level > marks all children as selected upon selecting the root');
            model.setSelection(true);
            expect(model.flatten().all(function(m) {
              return m.getSelection() === TreeSelector.Enum.select.ALL;
            }).value()).toBe(true);
          ...
          it('marks all children as unselected upon unselecting the root', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > at a depth of 2 level > marks all children as unselected upon unselecting the root');
            model.setSelection(false);
            expect(model.flatten().all(function(m) {
              return m.getSelection() === TreeSelector.Enum.select.NONE;
            }).value()).toBe(true);
          ...
          it('is partially selected if only some of its children are selected', function() {
            console.log('TreeSelector.SelectionStrategies.SelectionTree > at a depth of 2 level > is partially selected if only some of its children are selected');
            model.setSelection(false);
