...
define([
  ...
  './TreeSelector/TreeSelector-implementation',
  'css!./TreeSelector/styles/tree-selector'],
  function( $, _, Backbone, Dashboards, UnmanagedComponent, TreeSelector ) {
    ...
    TreeSelectorComponent = ( function ($, _, Backbone, Dashboards, UnmanagedComponent, TreeSelector) {
       ...
       */
      var IConfiguration, ISelector, Selector;
      ISelector = {
      ...
      IConfiguration = {
        ...
        getConfiguration: function() {
          ...
          configuration = {
            input: {},
            output: {},
            component: $.extend(true, {}, TreeSelector.defaults, TreeSelector.Enum.selectionStrategy[selectionStrategy], {
      ...
      Selector = UnmanagedComponent.extend(ISelector).extend(IConfiguration).extend({
        ...
        initialize: function() {
           ...
           */
          this.model = new TreeSelector.Models.SelectionTree(configuration.input.defaultModel);
           ...
           */
          this.inputDataHandler = new TreeSelector.DataHandlers.Input({
            model: this.model,
            options: configuration.input
          });
          this.outputDataHandler = new TreeSelector.DataHandlers.Output({
            model: this.model,
          ...
          if (!_.isEmpty(this.dashboard.detectQueryType(this.queryDefinition))) {
            queryOptions = {
              ajax: {
                error: function() {
                  deferred.reject({});
                  return TreeSelector.Logger.log("Query failed", 'debug');
                }
              }
            };
        ...
        onDataFail: function(reason) {
          TreeSelector.Logger.log('Component failed to retrieve data: #{reason}', 'debug');
      ...
      return Selector;
    })($, _, Backbone, Dashboards, UnmanagedComponent, TreeSelector);
