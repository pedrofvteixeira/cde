...
define([
    ...
    function( $, _, Mustache, Dashboards, AddIn, TreeSelector ) {
        ...
        (function(Dashboards, AddIn, Renderers) {
          ...
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderRootSelection', myAddIn);
        ...
        (function(Dashboards, AddIn, Renderers) {
          ...
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderRootSelection', myAddIn);
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderGroupSelection', myAddIn);
        })(Dashboards, AddIn, TreeSelector.Extensions.Renderers);
        ...
        (function(Dashboards, AddIn) {
          ...
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderItemSelection', myAddIn);
        })(Dashboards, AddIn);
        ...
        (function(Dashboards, AddIn, Sorters) {
          ...
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'sortItem', myAddIn);
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'sortGroup', myAddIn);
        ...
        (function(Dashboards, Mustache, AddIn) {
          ...
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderRootHeader', myAddIn);
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderRootFooter', myAddIn);
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderRootSelection', myAddIn);
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderGroupSelection', myAddIn);
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'renderItemSelection', myAddIn);
        })(Dashboards, Mustache, AddIn);
        ...
        (function(Dashboards, AddIn) {
          ...
          myAddIn = new AddIn({
            ...
            implementation: function($tgt, st, options) {
              st.model.on('change:isCollapsed', function(model, newState) {
                if (newState === false) {
                  return dashboard.trigger('selectors:close', model, options);
                }
              });
              st.model.listenTo(dashboard, 'selectors:close', function(model, opts) {
          ...
          Dashboards.registerGlobalAddIn('TreeSelectorComponent', 'postUpdate', myAddIn);
        })(Dashboards, AddIn);
