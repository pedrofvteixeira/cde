...
define([
    ...
    function( $, _, BaseComponent, BaseBone, BaseView, TreeSelector ) {
       ...
       */
      TreeSelector.Controllers.RootCtrl = BaseBone.extendWithEvents( BaseComponent ).extend( TreeSelector.Logger ).extend({
        ...
        onOnlyThis: function(model) {
          ...
          this.model.root().setSelection(TreeSelector.Enum.select.NONE);
          this.configuration.selectionStrategy.strategy.setSelection(TreeSelector.Enum.select.ALL, model);
          return this;
        }
      });
