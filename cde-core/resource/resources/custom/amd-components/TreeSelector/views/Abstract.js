...
define([
    ...
    function( _, Mustache, BaseView, TreeSelector, $ ) {
       ...
       */
      TreeSelector.Views.AbstractView = BaseView.extend( TreeSelector.Logger ).extend({
        ...
        getViewModel: function() {
          ...
          return $.extend(true, this.model.toJSON(), viewOptions, {
            ...
            isPartiallySelected: this.model.getSelection() === TreeSelector.Enum.select.SOME,
        ...
        onFilterClear: function(event) {
          var text;
          text = '';
          this.$('.selector-filter-input:eq(0)').val(text);
          this.trigger('filter', text, this.model);
          return this;
        },
